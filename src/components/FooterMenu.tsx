...
import { IoHomeSharp, IoHeartCircle  } from "react-icons/io5";
...
export default function FooterMenu() {
    ...
    <div className='w-[100%] bg-[#E6C6C8] fixed bottom-0 z-50 text-[#FDF9FA]' >
        <div className='w-[90%] mx-auto' >
            ...
            <Link className="flex flex-col items-center" href="/"><BsGrid1X2Fill className="text-[1.5rem] rotate-90"/><span>Galeria</span></Link>
